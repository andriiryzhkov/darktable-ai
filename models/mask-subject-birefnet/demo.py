"""Run BiRefNet (Swin Large) on an image and save a red-mask overlay.

Usage:
  python3 models/mask-subject-birefnet/demo.py \
      --model output/mask-subject-birefnet/model.onnx \
      --image samples/mask-object/example_03.jpg \
      --output models/mask-subject-birefnet/output/example_03.png
"""
