# Demo: run the MAN-Base x2/x3/x4 ONNX models on an image.
#
# The ONNX exports are static (x2: 512x512 input -> 1024x1024 output;
# x3: 336x336 -> 1008x1008; x4: 256x256 -> 1024x1024). The demo tiles
# the input, mirror-pads tile edges, and stitches with overlap trimming —
# matching what darktable does at runtime with OVERLAP_UPSCALE=16.
#
# Models are FP16 by default; the loader reads the input dtype from the
# session and casts tiles accordingly.
...
def main():
    parser = argparse.ArgumentParser(description='Run MAN-Base ONNX Demo')
