...
#
# Usage:
#   python3 scripts/mask-depth-da3mono-large/demo.py \
#       --model models/mask-depth-da3mono-large/model.onnx \
#       --image images/example_01.jpg \
#       --output scripts/mask-depth-da3mono-large/output/depth_01.png
