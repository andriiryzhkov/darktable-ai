# Demo: run the HQ-SAM Light (TinyViT) ONNX model on an image with a single
# point prompt and save the source image with a red mask overlay.
# Single HQ-token-only mask output.
#
# Usage:
#   python3 scripts/mask-object-samhq-light/demo.py \
#       --encoder models/mask-object-samhq-light/encoder.onnx \
#       --decoder models/mask-object-samhq-light/decoder.onnx \
#       --image images/example_03.jpg \
#       --point 0.28,0.65 \
#       --output scripts/mask-object-samhq-light/output/example_03.png
...
def main():
    parser = argparse.ArgumentParser(description="HQ-SAM Light (TinyViT) ONNX segmentation demo.")
    ...
    image_embeddings, interm_embeddings = enc_outputs
