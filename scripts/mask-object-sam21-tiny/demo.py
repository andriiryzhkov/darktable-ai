# Demo: run the custom-exported SAM 2.1 Tiny ONNX model on an image with a
# single point prompt and save the source image with a red mask overlay.
#
# Usage:
#   python3 scripts/mask-object-sam21-tiny/demo.py \
#       --encoder models/mask-object-sam21-tiny/encoder.onnx \
#       --decoder models/mask-object-sam21-tiny/decoder.onnx \
#       --image images/example_03.jpg \
#       --point 0.28,0.65 \
#       --output scripts/mask-object-sam21-tiny/output/example_03.png
...
def main():
    parser = argparse.ArgumentParser(description="SAM 2.1 Tiny ONNX segmentation demo.")
