# Demo: run the custom-exported SAM 2.1 Small ONNX model on an image with a
# single point prompt and save the source image with a red mask overlay.
#
# Usage:
#   python3 scripts/mask-object-sam21-small/demo.py \
#       --encoder models/mask-object-sam21-small/encoder.onnx \
#       --decoder models/mask-object-sam21-small/decoder.onnx \
#       --image images/example_03.jpg \
#       --point 0.28,0.65 \
#       --output scripts/mask-object-sam21-small/output/example_03.png
...
def main():
    ...
    # Decoder expects point_coords [B, N, 2] and point_labels [B, N] (both float32)
