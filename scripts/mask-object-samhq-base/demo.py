# Demo: run the HQ-SAM ViT-B ONNX model on an image with a single point
# prompt and save the source image with a red mask overlay.
# Single HQ-token-only mask output.
#
# Usage:
#   python3 scripts/mask-object-samhq-base/demo.py \
#       --encoder models/mask-object-samhq-base/encoder.onnx \
#       --decoder models/mask-object-samhq-base/decoder.onnx \
#       --image images/example_03.jpg \
#       --point 0.28,0.65 \
#       --output scripts/mask-object-samhq-base/output/example_03.png
...
def main():
    parser = argparse.ArgumentParser(description="HQ-SAM ViT-B ONNX segmentation demo.")
